  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        <Header />
        <main className={`flex-1 ${location.pathname !== '/' ? 'pt-[104px]' : ''}`}>
          <Outlet />
        </main>
        <Footer />
        ...
        <div className="fixed bottom-8 right-8 z-[60] flex flex-col gap-4">
          ...
          <motion.a
            ...
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
            className="flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-transform group relative"
